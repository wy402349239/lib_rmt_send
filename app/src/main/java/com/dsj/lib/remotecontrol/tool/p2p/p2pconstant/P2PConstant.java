package com.dsj.lib.remotecontrol.tool.p2p.p2pconstant;
...
public class P2PConstant {
    ...
    public static final String FILE_SHARE_SAVE_PATH = "DSJ_LIB_REMOTE";
    ...
    public interface CommandNum {
        ...
        public static final int Receipt_STR_REQ = 16;//接收消息回执
    }
